...
-- alter database sales_management CHARACTER SET = utf8mb4;
...
('BC01','But chi','cay','Singapore',3000),
 ...
 (1003,'2006-08-23','KH02','NV01',100000), (1004,'2006-01-09','KH02','NV01',180000),
(1005,'2006-10-20','KH01','NV02',3800000), (1006,'2006-10-16','KH01','NV03',2430000), 
(1007,'2006-10-28','KH03','NV03',510000), (1008,'2006-10-28','KH01','NV03',440000), (1009,'2006-10-28','KH03','NV04',200000),
 (1010,'2006-11-01','KH01','NV01',5200000), (1011,'2006-11-04','KH04','NV03',250000), (1012,'2006-11-30','KH05','NV03',21000), 
 (1013,'2006-12-12','KH06','NV01',5000), (1014,'2006-12-13','KH03','NV02',3150000), (1015,'2007-01-01','KH06','NV01',910000), 
 (1016,'2007-01-01','KH07','NV02',12500), (1017,'2007-01-02','KH08','NV03',35000), (1018,'2007-01-13','KH08','NV03',330000), 
 (1019,'2007-01-13','KH01','NV03',30000), (1020,'2007-01-14','KH09','NV04',70000), (1021,'2007-01-16','KH10','NV03',67500), 
 (1022,'2007-01-16',null,'NV03',7000), (1023,'2007-01-17',null,'NV01',330000);
 ...
 (1002,'BB01',20), 
 (1002,'BB02',20),
(1003,'BB03',10), (1004,'TV01',20), 
(1004,'TV02',10), (1004,'TV03',10), 
(1004,'TV04',10), (1005,'TV05',50),
 (1005,'TV06',50), (1006,'TV07',20),
 ...
 (1015,'BB02',30), (1015,'BB03',7), (1016,'TV01',5), (1017,'TV02',1),
 (1017,'TV03',1), (1017,'TV04',5), (1018,'ST04',6), (1019,'ST05',1), (1019,'ST06',2),
 (1020,'ST07',10), (1021,'ST08',5), (1021,'TV01',7), (1021,'TV02',10), (1022,'ST07',1), (1023,'ST04',6);
...
-- 1
select id,name ,origin from product
where origin = "Trung Quoc";

-- 2
select id,name,unit from product
...
-- 6
select id , invoice_total , invoice_date from invoice
...
from invoice where invoice_date = 2006;

-- 14 
select sum(p.price * d.amount) as total_profit from invoice i
join invoice_detail d on d.invoice_id = i.id
join product p on d.product_id = p.id
where i.invoice_date = 2006;
